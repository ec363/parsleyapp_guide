...
<!-- refs: # title {#title-link}
then \@ref(title-link) which displays as the chapter/section/etc number eg "2.0.1"
or [any text here](#title-link) which displays as "any text here" -->

<!-- test1 \@ref(guideintro)   -->
<!-- test2 [text](#guideintro) -->

<!-- #### A Step by Step Guide to Using Parsley {#guideintro} -->
<!-- <br> -->
...
<!-- This <i class="fa-solid fa-map"></i> Guide will take you through the steps of using Parsley to solve this problem. -->

<!-- <i class="fa-solid fa-arrow-right-long"></i> <i class="fa-solid fa-circle-info"></i>  -->
<!-- <i class="fa-solid fa-arrow-right-long"></i> <i class="fa-solid fa-circle-question"></i>  -->
...
### Step 3: Data from first reading {#step3}
<hr>
